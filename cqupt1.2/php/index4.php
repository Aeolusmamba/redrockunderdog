...
$code = $_POST["identify"];
$result = mysqli_query($a, "SELECT verification_code , verification_time FROM USERINFO WHERE ID = '" . $id . "'");
...
if ($num == 0 or $rearr['verification_code'] != $code) {   //验证码不正确
    ...
    mysqli_query($a, "UPDATE USERINFO SET verification_code=null, verification_time=null,password='".$new_pwd."' WHERE ID ='" . $id . "'");
